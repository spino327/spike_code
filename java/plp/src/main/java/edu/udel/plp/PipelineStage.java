...
/**
 * Class that represents the stage in the pipeline.
...
public abstract class PipelineStage<I, O> implements Runnable {
    ...
    protected BlockingQueue<I> in;
    protected BlockingQueue<O> out;
    private CountDownLatch cdl;
    protected boolean done;
    
    public void init (BlockingQueue<I> in, BlockingQueue<O> out, CountDownLatch s) {
        this.in = in;
        this.out = out;
        this.cdl = s;
    }
    ...
    public void handleComputeException (Exception e) {
        e.printStackTrace();
    }
